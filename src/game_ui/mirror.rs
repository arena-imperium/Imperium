// this file is needed to get bevy_mod_picking to work with cuicui_chirp
// It is copied from a cuicui example, but will be added to a dedicated cuicui crate in the future
