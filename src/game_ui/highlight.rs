...
/// A plugin for making ui components highlight on mouse hover.
///
/// Any ui element with the Highlight component will have its
/// color changed to the components color value changed
///
/// When we want to add some polish we can add additional
/// affects on highlight.
